...
return [
     ...
     */
    'description' => "List of all endpoints for Toppoffert.se web software hosted at https://toppoffert.se",

    /*
     * The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url').
     */
    'base_url' => "https://toppoffert.se",
    ...
    'static' => [
         ...
         */
        'output_path' => 'resources/views/docs',
    ],
