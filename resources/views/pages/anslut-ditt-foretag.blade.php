...
<body class="supplier-register">
    ...
    <div class="legacy-browser-warning alert-site">
        ...
        <header class="new-header">
                <div class="new-header-container" style="background:#fff !important;">
...
<section class="splash-supplier-register" style="background:#0055aa;">
    <div class="splash-supplier-register__inner no-spacing__bottom">
        <div class="splash-supplier-register-column supplier-register-form-container">
            <h1 class="splash-title" style="font-family:'Spartan', 'GD Sherpa Regular';">
              
            Företag som hittar nya kunder
            </h1>
            <div class="splash-subtitle" style="font-family:'Spartan', 'GD Sherpa Regular';">
              ...
              @endif
                ...
                <div class="input-group option-with-zone">
                    <label>
                        ...
                        <div style="font-family:Spartan,GD Sherpa Regular;">
                            Jag godkänner {{config('app.name')}} användarvillkor</div>
                    </label>
                </div>
                <div class="button-wrapper">

                    <button type="submit" class="supplier-register-submit" style="background:#0055aa;">
