...
<div id="messages" class="row city main-container wht-bg shif-dw">
...
<div class="row" style="border-radius:10px;padding-top:9px;margin:0;">
...
<div class="row" style="border-radius:10px; background:#e8f2ff;margin-left:5px;padding-top:9px;">
...
for($i=0;$i< sizeof($files)-1;$i++){  @endphp
...
<span><a href="tel:{{\App\Models\User::get_data('phone_no',$buyer_id)}}">{{\App\Models\User::get_data('phone_no',$buyer_id)}}</a></span>
</p>

<p class="info_item">
<span>Alt. Telefonnummer:</span>
<span><a href="tel:{{\App\Models\User::get_data('telephone',$buyer_id)}}">{{\App\Models\User::get_data('telephone',$buyer_id)}}</a>
</span>
</p>
