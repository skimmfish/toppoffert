...
<div class="mesg_box bxscroll" id="bxscroll" style="background:none;padding:0 12px 5px 12px !important;height:400px;overflow-y:scroll;overflow-x:hidden;">
...
<div class="message_footer" id="divv_msg_box" style="background:none !important;">
    ...
    <input type="hidden" name="uid" value="{{$supplier_id}}" />
