...
.text-center{diplay:block; margin:auto;text-align:center; } .alert{    background:#9dddc2;padding:10px;border-radius:5px;color:#000;}</style>
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="input-wrapper">
                            <div class="form-group text-input">
                                ...
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus reqired />
                            </div>
                        ...
                        <div class="form-group submit-and-links">
                            ...
                            <button type="submit" id="submit" class="button button-rounded button-login" style="font-size:12.5px;">Återställ lösenord</button>
