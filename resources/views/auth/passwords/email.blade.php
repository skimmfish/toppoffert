...
.logo-wrapper{
    ...
    justify-content:center;margin-bottom:-90px
...
<a href="{{route('index')}}" class="logo-offerta">
        ...
        <div class="row">
                    ...
                    <div class="login-box" style="background:#fff;padding:15px 29px;border-radius:15px;">
                        ...
                        <form id="form" method="post" novalidate action="{{ route('password.email') }}">
                            ...
                            <div class="form-group text-input">
                                ...
                                <label for="Email" class="de-blue">E-post</label>
                                <span class="error-message field-validation-valid" data-valmsg-for="email" data-valmsg-replace="true">

                                </span>
                            </div>
                            <div class="form-group">
                                <button type="submit" id="submit" class="button button-rounded" style="background:#0055aa;height:60px;border-radius:50px;">Skicka
