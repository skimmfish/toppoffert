...
<div class="app-wrapper" data-v-261a2392="">
    <header class="header" data-v-261a2392=""><div class="top-nav-wrapper" data-v-261a2392="">
        <div class="left-content"><nav class="top-nav">
            <a href="{{route('marketplace.clients')}}" class="top-nav-link home">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="svg-icon svg-icon--size-medium svg-icon--spacing-right-tiny fill-current-color"><path d="M11.246 24a.743.743 0 01-.53-.22.745.745 0 01-.205-.677l.75-3.75a.748.748 0 01.205-.384l7.631-7.63a2.844 2.844 0 012.026-.839 2.873 2.873 0 012.03 4.899l-7.627 7.629a.74.74 0 01-.384.205l-3.749.75a.615.615 0 01-.147.017zm.956-1.706l2.424-.485 7.467-7.469a1.368 1.368 0 00-.027-1.962 1.33 1.33 0 00-.941-.379c-.366 0-.71.142-.968.401l-7.471 7.47-.484 2.424zM2.242 21a2.252 2.252 0 01-2.25-2.25V2.25A2.252 2.252 0 012.242 0h15a2.252 2.252 0 012.25 2.25V9a.75.75 0 01-1.5 0V2.25a.75.75 0 00-.75-.75h-15a.75.75 0 00-.75.75v16.5c0 .414.336.75.75.75h6a.75.75 0 010 1.5h-6z"></path><path d="M8.242 6a.75.75 0 010-1.5h6a.75.75 0 010 1.5h-6zM5.242 10.5a.75.75 0 010-1.5h9a.75.75 0 010 1.5h-9zM5.242 15a.75.75 0 010-1.5h7.5a.75.75 0 010 1.5h-7.5z"></path></svg><span role="link" class="top-nav-text">Förfrågningar</span></a><a href="{{route('feeds')}}" class="top-nav-link feed"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="svg-icon svg-icon--size-medium svg-icon--spacing-right-tiny fill-current-color"><path d="M15.08 20.746a1.502 1.502 0 01-1.421-1.016L8.921 4.993l-2.596 6.128A2.241 2.241 0 014.25 12.5H.75a.75.75 0 010-1.5h3.5a.748.748 0 00.693-.462l2.602-6.12a1.498 1.498 0 011.967-.792c.392.167.695.493.833.896l4.738 14.738 2.579-6.851A2.256 2.256 0 0119.748 11h3.5a.75.75 0 010 1.5h-3.5a.748.748 0 00-.693.462l-2.586 6.843a1.524 1.524 0 01-.907.861c-.156.053-.318.08-.482.08z"></path></svg><span class="top-nav-text">Händelser</span><span class="notification-dot"></span>
            </a>
            </nav>
        </div>
        <div class="middle-content">
            <a href="{{route('index')}}" class="">
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="130.000000pt" height="60.000000pt" viewBox="0 0 500.000000 500.000000"
