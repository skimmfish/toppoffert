...
-66 5z"/>
        ...
        <div class="dropdown-toggle top-nav-link settings" data-bs-toggle="dropdown" aria-haspopup="true" id="profile_dd">
        ...
        <span class="dropdown-text" data-v-48ce88d6="">{{\Auth::user()->f_name}}</span><!----><!----><!---->
