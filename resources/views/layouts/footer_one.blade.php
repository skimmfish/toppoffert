...
<footer class="new-footer">
    <div class="new-footer__inner">
      <div class="new-footer__inner mobile-logo">
        <a href="" class="new-footer__inner--link" aria-label="Hem">
          
  <img src="{{asset('img/logos/site_logo.svg')}}" lazyloading class="img-responsive" />
  ...
  <svg data-name="Outline Version" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="icon-medium">
    ...
    <circle cx="18.84" cy="5.15" r="1.25" />
      ...
      <div class="new-footer__inner--item">
        <nav class="footer-menu">
          <a class="footer-menu__item blog" href="blogg/{{route('index')}}">
            Blogg
          </a>
          <a class="footer-menu__item companies-blog" href="framgangscoachen/{{route('index')}}">
            Företagsblogg
          </a>
          <a class="footer-menu__item" href="press/{{route('index')}}">
            Press
          </a>
          <a class="footer-menu__item" href="anvandarvillkor/leverantor/{{route('index')}}">
            Integritetspolicy
          </a>
        ...
        <div>
          ...
          <div class="media">
            <span>
              ...
              <a class="footer-menu__item" href="kontakta-oss/{{route('index')}}">
                Skicka meddelande
              </a>
            </span>
          </div>
...
<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="1400.000000pt" height="1400.000000pt" viewBox="0 0 600.000000 600.000000"
...
-66 5z"/>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24" class="icon icon-medium">
    ...
    <path d="M11.997 18a3.754 3.754 0 0 1-3.75-3.75 3.754 3.754 0 0 1 3.75-3.75 3.754 3.754 0 0 1 3.75 3.75 3.754 3.754 0 0 1-3.75 3.75zm0-6c-1.241 0-2.25 1.009-2.25 2.25s1.009 2.25 2.25 2.25 2.25-1.009 2.25-2.25S13.238 12 11.997 12z" />
      ...
      <a href="anslut-ditt-foretag/{{route('index')}}" class="new-footer__footer-menu--link supplier-register-link">
