...
.blue_bg{
padding:50px auto 0 50px;
didsplay:grid;grid-template-columns:20% 60% 20%;
    color:#fff;text-align:center;font-size:40px;font-family:'Open Sans';font-weight:800;
    margin:block
}
.svg .icon{
    fill:#fff;stroke:#fff;
...
.main-div{
vertical-align:middle;padding-top:170px;
padding-left:170px;padding-right:170px;
}
.body{display:flex;flex-direction:row;justify-content:center;padding:200px 250px 0 250px;font-family:Open Sans;font-size:17px;font-weight:800;color:#fff;text-align:center;}
...
<span>  Din förfrågan har skickats till 100-tals företag, vänligen vänta tills de når dig</span>
