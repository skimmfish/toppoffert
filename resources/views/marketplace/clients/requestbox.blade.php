...
<div class="col-md-10 col-lg-10 col-xl-10 col-sm-10 col-xs-12">
...
<div class="row" style="border-radius:10px;background:#fff;padding-top:10px;margin:10px 0 9px 0;">

<div class="col-md-2 col-xs-2">

@if(is_null($seller_img) || file_exists(public_path('img/avatar/'.$seller_img)))
<img src="{{asset('img/avatar/'.$seller_img)}}" lazyloading class="img-responsive-sm grey_bg"/>
@else
...
<div class="row msgg" style="border-radius:10px; background:#e0e8f2;padding-top:10px;margin:10px 0 9px 0" id="mgsbx">
...
<a href="#" data-attr="" data-target="#requestModal" data-toggle="modal" id="viewImage">
<img src="{{asset('img/requests/'.$files[$i])}}" class="img-responsive-lg" lazyloading/>
</a>
</div>
...
</svg><span class="text-sm">Öppna Chatt</span>
</a>-->
...
<div class="row">
    ...
    <form action="{{route('marketplace.buyers.sendmsg')}}" method="POST" enctype="multipart/form-data" style="margin-top:-12px !important;margin-bottom:15px;width:100%">
    {{csrf_field()}}
    ...
    <div class="form-group">
        <textarea class="msg_box form-control" name="request_response" style="height:95px !important;border-radius:10px;" required placeholder="Ange din korrespondens här, köparen återkommer när de ser ditt meddelande!" style="padding-top:7px;"></textarea>
        </div>
        <div class="form-group">
...
<div class="message_footer" id="divv_msg_box" style="background:none !important;">
    ...
    <div class="form-group">
        <textarea class="msg_box form-control" name="request_response" required placeholder="Ange din korrespondens här, köparen återkommer när de ser ditt meddelande!" style="padding-top:7px;"></textarea>
        </div>
        <div class="form-group">
        <label class="form-label">Ladda upp dokument här</label>    
        <input type="file" class="form-control input-control-md" placeholder="Please select a file for your portfolio if you got one" name="filer"/>
